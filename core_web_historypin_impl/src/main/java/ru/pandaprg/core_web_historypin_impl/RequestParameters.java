...
import ru.pandaprg.core_web_historypin_api.Boundsable;
import ru.pandaprg.core_web_historypin_api.RequestParametersContract;

public class RequestParameters implements RequestParametersContract {
    ...
    public class Bounds implements Boundsable {
